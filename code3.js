...
function calculateTax (){
    ...
    let nhifCalculator = function (){
        ...
        payeamount=calculatepaye()
            nsssfDeductions=NSSFCalculator()
            NHIF=nhifCalculater()
            totalTaxes=paye+NHIF+nssfDeductions;
            netsalary=salary-totalTaxes

            console.log('Hi your salary is ${salary}) , NHIF is ${NHIF} , nssfDeductions is ${nssfDeductions} , paye is ${payeAmount}.
            Therefore,your total tax is ${total Taxes} and net salary is ${netSalary})
